...
public class AbstractPageUI {
	public static final String MANAGER_LINK = "//ul[@class='menusubnav']//a[text()='Manager']";
	...
	public static final String FUN_TRANSFER_LINK = "//ul[@class='menusubnav']//a[text()='Fund Transfer']";
