...
public class Payment extends AbstractTest {
	...
	public void Payment_01_CreateNewCustomer() {
		...
		newCustomerPage.inputToDynamicTextboxOrTextArea(driver, "state", PaymentTestData.CITY);
		...
		newCustomerPage.inputToDynamicTextboxOrTextArea(driver, "emailid", PaymentTestData.EMAIL + randomNumber() + "@gmail.com");
		...
		verifyEquals(newCustomerPage.getTextDynamicTableInfo(driver, "Email"), PaymentTestData.EMAIL);
	...
	public void Payment_02_EditCustomer() {
		...
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "name"), PaymentTestData.NAME);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "gender"), PaymentTestData.GENDER);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "dob"), PaymentTestData.DATE_OF_BIRTH);
		verifyEquals(editcustomerPage.getTextInDynamicTextArea(driver, "addr"), PaymentTestData.ADDRESS);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "city"), PaymentTestData.CITY);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "state"), PaymentTestData.STATE);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "pinno"), PaymentTestData.PIN);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "telephoneno"), PaymentTestData.MOBILE_NUMBER);
		verifyEquals(editcustomerPage.getTextValueInDynamicTextbox(driver, "emailid"), PaymentTestData.EMAIL);
	...
	public void Payment_04_EditAccount() {
		...
		verifyEquals(editAccountPage.getTextValueInDynamicTextbox(driver, "txtinitdep"), PaymentTestData.INITIAL_AMOUNT);
	...
	public void Payment_10_DeleteCustomerAndVerify() {
		...
		verifyTrue(deleteCustomerPage.isDynamicPageTitleDisplayed(driver, "Delete Account Form"));
