...
public class NewCustomerPageUI {
	public static final String USER_ID_INFO = "mngr192372";
	public static final String PASSWORD_INFO = "EqAqabU";
	...
	public static final String NUMERIC_VALUE_NAME = "haitp31788";
	public static final String NUMERIC_ARE_NOT_ALLOW_MESSAGE = "//label[text()='Numbers are not allowed']";
	public static final String SPECIAL_CHARACTERS_NAME = "haitp@#";
